...
// block-count throttle, inside `Engine::ProcessBlock`
// (External/Sheaf/projects/synth/include/synth/Engine.hpp), are all exercised
...
public:
    ...
    // (Bank::OpenModulationView, External/Sheaf/projects/synth/src/ParameterModulation.cpp): one
...
TEST_CASE(mono_group_populate_ui_state_publishes_single_voice) {
    ...
    // (`Engine::ProcessBlock`, External/Sheaf/projects/synth/include/synth/Engine.hpp) -- pump enough blocks
