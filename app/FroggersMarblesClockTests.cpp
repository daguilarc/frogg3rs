...
// neutral/off" (ModulationDepthConfig, External/Sheaf/projects/synth/src/ParameterModulation.cpp:
...
// owns (External/Sheaf/projects/synth/include/synth/StandardModulators.hpp) before registering it as a
...
// (`GangedRandomLfoAtomicColor`, External/Sheaf/projects/synth/include/synth/DspRandomLfo.hpp), even though the registered ModulatorMetadata
...
// per-voice UiState (External/Sheaf/projects/synth/include/synth/GangedRandomLfoVisualizer.hpp's
// `voice.color`, populated by GangedRandomLfoProcessor::PublishUiState
// from `m_voiceColors`, External/Sheaf/projects/synth/include/synth/DspRandomLfo.hpp), NOT from
...
// so `ComputeTiming` (External/Sheaf/projects/synth/include/synth/GangedRandomLfoVisualizer.hpp) has a
