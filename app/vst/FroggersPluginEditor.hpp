...
//     (External/Sheaf/projects/synth/juce/PortableJuceBackend.hpp, `explicit PortableComponent(synth::
...
//     and `surface.DispatchAction(...)` (`DispatchBackendAction()`), both
//     members of the GENERIC synth::ui::Surface interface
//     (Sheaf External/Sheaf/projects/synth/include/synth/PortableUI.hpp). MainPane hands it
...
// exactly this seam (Sheaf External/Sheaf/projects/synth/runtime/MainPane.hpp, `mainComponent_.
...
// Sheaf External/Sheaf/projects/synth/include/synth/PortableUI.hpp) -- EditorSurface() already
// returns that interface, so registering needs no new accessor.
//
// Safety split, replicated from MainPane (External/Sheaf/projects/synth/runtime/MainPane.hpp,
...
// (External/Sheaf/projects/synth/include/synth/RuntimeMainComponent.hpp) is `IsControllersAction(action.name) &&
...
public:
    ...
    // External/Sheaf/projects/synth/runtime/Shell.hpp) exactly for both hooks.
...
private:
    ...
    // (Sheaf External/Sheaf/projects/synth/runtime/MainPane.hpp) minus its conditional
